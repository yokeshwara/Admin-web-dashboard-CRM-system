...
const navItems: NavItem[] = [
  ...
  { title: "Clients", href: "/clients", icon: Users, roles: ["Admin", "Sub-Admin"], color: "bg-purple-500" },
  { title: "Assets", href: "/assets", icon: Users, roles: ["Admin", "Sub-Admin"], color: "bg-purple-500" },
  {
